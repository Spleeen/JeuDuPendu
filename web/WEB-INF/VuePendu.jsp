...
<html>
    ...
    <body>
        ...
        <script src="http://french.jotform.com/js/vendor/jquery-1.8.0.min.js?v=3.2.526" type="text/javascript"></script>
        <script src="http://french.jotform.com/js/vendor/maskedinput.min.js?v=3.2.526" type="text/javascript"></script>
        <script src="http://french.jotform.com/static/jotform.js?3.2.526" type="text/javascript"></script>
                ...
                <ul class="form-section">
                    ...
                    <table id="pendu" cellpadding="0" cellmargin="0" border="0" >
                        ...
                        <li class="form-line" id="id_1">
                            <label class="form-label-top" id="label_1" >
                                Tapez une lettre<span class="form-required">*</span>
                            </label>
                            <div id="cid_1" class="form-input-wide">
                                <input maxlength="1" type="text" class=" form-textbox validate[required, Alphabetic]" data-type="input-textbox" id="inputLetter" name="inputLetter" size="1" value="" />
                            </div>
                        </li>
                        </td>
                        <td>
                            ...
                            <td colspan="2">
                                ...
                                <h1>Lettres déjà testées :
                                    <%
                                        ...
                                        for (Character c : pendu.getCharTested()) {
                                            out.println(" " + c);
                                        }
                                    %></h1>
